<!-- footer -->
<section id="footer" class="text-center bg-slate-950 px-6 py-8">

    <!-- about -->
    @if(!$page->getPath())
        <div id="about" class="text-center">
            <div class="max-w-3xl border-b border-white/30 mx-auto pt-4 pb-12 mb-6">
                <p class="">“Live for the line” was a phrase that my late Uncle Mike would use to illustrate the brevity of life.</p>
                <p class="mt-3">He would compare our lives to a mere dot on a line representing eternity. Life is a "vapors breath" in comparison to eternity. Therefore we should <b class="text-yellow-500 inline-block">live for the line</b>, spending our lives on what is eternally valuable: the glory of God in Jesus Christ (John 17:3).</p>
    ...
    <div class="sm:flex justify-center text-white font-semibold leading-loose uppercase">
        ...
        <a class="border-b border-slate-100/50 mx-2.5 hover:text-yellow-500" href="/now">Now</a>
        <a class="border-b border-slate-100/50 mx-2.5 hover:text-yellow-500" href="/merch">Merch</a>
