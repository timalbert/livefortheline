        ...
        <div class="max-w-screen-xl mx-auto px-8">
            ...
            <form class="mt-12 max-w-4xl mx-auto" name="contact" method="POST" action="/success" data-netlify="true">
                ...
                <div>
                    ...
                    <textarea id="message" name="message" placeholder="Your message" rows="6" class="bg-white text-slate-900 w-full py-3 px-4 leading-6 focus:shadow-outline rounded-md border mb-6" required=""></textarea>
                </div>
                <div>
