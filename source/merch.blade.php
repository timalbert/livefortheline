    ...
    <div class="max-w-4xl pb-12 px-6 mt-10 mx-auto">
        <div class="text-xl leading-relaxed">
            <div class="prose:dark prose-xl prose-white prose-a:text-yellow-500 hover:prose-a:text-zinc-500 hover:prose-a:border-b hover:prose-a:border-zinc-500">
                ...
                <p class="leading-normal text-zinc-300 my-3">Thanks to play it again sports setting up an online storefront for a small set of "Live for the Line" gear.</p>
                ...
                <div class="mt-12 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 xl:gap-x-12 text-center">
                    ...
                    <div>
                        ...
                        <p class="text-base"><a target="_blank" href="https://livefortheline.itemorder.com/shop/category/102349/">Drinks</a> and <a target="_blank" href="https://livefortheline.itemorder.com/shop/category/111799/">Headwear</a>
                    </div>
                </div>
            </div>
        </div>
